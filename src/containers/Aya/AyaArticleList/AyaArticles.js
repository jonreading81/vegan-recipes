...
import {AyaHeroPanel} from 'components';
...
@asyncConnect([
  ...
  },
  {
    promise: ({params, store: {dispatch}}) => {
      return dispatch(requestList([5, params.term], params.page));
    }
  }
])
    ...
    return (
      <div>
        <Helmet title={page.getTitle()}/>
          ...
          <If condition={!isFetching}>
            <AyaHeroPanel image={page.getImage()} title={page.getTitle()} heroStyle="image-focus-bottom">
               {subTextComponent}
            </AyaHeroPanel>
          </If>
        <div className="container ">
          <div className="column-large">
            <If condition={ articles.length === 15 }>
